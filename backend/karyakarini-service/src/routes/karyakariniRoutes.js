...
router.get('/my/activity-submissions', controller.getMyActivitySubmissions);
router.post('/my/activity-submissions', controller.createMyActivitySubmission);
...
router.put('/my/category-activities/:activityId', controller.updateMyCategoryActivity);
router.delete('/my/category-activities/:activityId', controller.deleteMyCategoryActivity);
